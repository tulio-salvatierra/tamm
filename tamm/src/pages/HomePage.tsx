  ...
  return (
    <>
      ...
      <div className=" p-8">
        ...
        <div className="text-center bg-green-200 rounded-2xl p-8">
          <h1 className="text-[4rem] text-mainBlue sm:text-6xl">
            Why Choose TAMM Cleaning Services?
          </h1>
          <ul className="text-slate-400  list-none text-center justify-start p-4 text-[2rem] text-bold bg-white rounded-xl m-5">
            <li>
          ...
          <h2 className="text-[4rem] text-mainBlue sm:text-6xl">
