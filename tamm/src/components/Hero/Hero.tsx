      ...
      <div className="container-xxl bg-inherit py-12 md:py-24 lg:py-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div className="space-y-6 px-4 md:px-6 text-left z-10">
            ...
            <p className="p-4 bg-transparent text-body text-h4 mb-40 max-w-[900px] md:text-lg lg:text-lg xl:text-lg">
            ...
            <Button
              ...
              className="p-8 mt-10 bg-lightGreen text-mainBlue text-lg self-center w-100  transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-100 hover:bg-indigo-100 duration-100 rounded-2xl"
            >
